...
namespace lbf {
	namespace python {
		...
		public:
			std::vector<cv::Mat_<uint8_t>> _image_vec_train;
			std::vector<cv::Mat_<uint8_t>> _image_vec_test;
			std::vector<cv::Mat_<double>> _shape_vec_train;
			std::vector<cv::Mat_<double>> _normalized_shape_vec_train;
			std::vector<cv::Mat_<double>> _shape_vec_test;

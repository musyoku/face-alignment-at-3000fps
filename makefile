...
running_tests:	## 学習テスト
	$(CC) test/running_tests/validation.cpp src/lbf/*.cpp src/lbf/randomforest/*.cpp src/python/*.cpp src/lbf/liblinear/*.cpp src/lbf/liblinear/blas/*.c -o test/running_tests/validation $(INCLUDE) $(LDFLAGS) -O3 -fopenmp -Wno-deprecated
